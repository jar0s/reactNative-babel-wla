  ...
  render() {
    const buttonsMatrix = [
      ...
      [
        ...
        {text: translations['number.nine'], size: 'double', tapParams: {type: 'number', value: 9}},
      ],
      [
        {text: translations['number.four'], size: 'double', tapParams: {type: 'number', value: 4}},
      ...
      [
        ...
        {text: translations['number.two'], size: 'double', tapParams: {type: 'number', value: 2}},
      ...
      [
        ...
        {text: translations['symbol.dot'], size: 'double', tapParams: {type: 'number', value: '.'}},
      ],
      [
